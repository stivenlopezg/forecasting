...
The Tidyverts framework defines a number of other functions to help in exploratory analysis, in the feasts package. For plotting, the `gg_subseries` function produces a seasonal subseries plot, which facets the time series by each season in the seasonal period:
